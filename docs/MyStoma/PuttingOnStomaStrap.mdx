...
Here, you can really see that peristomal hernia on my left hand side. The belt support will serve to squash that down shortly.
...
You can see here that the peristomal hernia is supported (aka squashed down) by the belt and support base. 
